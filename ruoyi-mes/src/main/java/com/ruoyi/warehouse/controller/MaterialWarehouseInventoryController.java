...
//        util.exportExcel(response, list, "物料实时库存数据");
    ...
    @Log(title = "物料实时库存", businessType = BusinessType.INSERT)
    @PostMapping
    public AjaxResult add(@RequestBody MaterialWarehouseInventory materialWarehouseInventory)
    {
        return toAjax(materialWarehouseInventoryService.insertMaterialWarehouseInventory(materialWarehouseInventory));
    }
    ...
    @Log(title = "物料实时库存", businessType = BusinessType.UPDATE)
    @PutMapping
    public AjaxResult edit(@RequestBody MaterialWarehouseInventory materialWarehouseInventory)
    {
        return toAjax(materialWarehouseInventoryService.updateMaterialWarehouseInventory(materialWarehouseInventory));
    }
    ...
    @Log(title = "物料实时库存", businessType = BusinessType.DELETE)
	@DeleteMapping("/{ids}")
    public AjaxResult remove(@PathVariable Long[] ids)
    {
        return toAjax(materialWarehouseInventoryService.deleteMaterialWarehouseInventoryByIds(ids));
    }
}
